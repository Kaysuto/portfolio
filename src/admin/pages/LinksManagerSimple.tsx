...
export const LinksManagerPage = () => {
  ...
  const IconSelector = () => (
    <div className="mt-2">
      <div className="grid grid-cols-6 gap-2 max-h-40 overflow-y-auto border border-gray-300 rounded-lg p-2">
  ...
  const FormModal = () => (
    <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl p-6 w-full max-w-md border shadow-xl">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input 
              ...
              className="w-full px-4 py-3 bg-white rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200 text-gray-900 placeholder:text-gray-500 mt-1"
            />
          </div>
  ...
  const DeleteConfirmModal = () => (
    <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl p-6 w-full max-w-sm border shadow-xl">
  ...
  return (
    <div className="container mx-auto px-6 py-8">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Gestionnaire de Liens</h1>
          <p className="text-gray-600 mt-2">Gérez vos liens avec une interface style solo.to</p>
        </div>
        <Button
          onClick={() => setShowAddForm(true)}
          className="bg-blue-600 hover:bg-blue-700 text-white group transition-all duration-300 hover:scale-105"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        {[
          { label: "Total Liens", value: links.length, color: "text-gray-900" },
          { label: "Actifs", value: links.filter(l => l.isActive).length, color: "text-green-600" },
          { label: "Total Clics", value: links.reduce((sum, l) => sum + l.clicks, 0), color: "text-blue-600" },
          { label: "Moy. Clics", value: Math.round(links.reduce((sum, l) => sum + l.clicks, 0) / links.length), color: "text-purple-600" }
        ].map((stat, index) => (
          <div key={index} className="bg-white rounded-xl p-4 border border-gray-200 hover:border-blue-300 transition-all duration-300 shadow-sm">
        ...
        {links
          ...
          .map((link) => {
            ...
            return (
              <div
                key={link.id}
                className={`bg-white rounded-xl p-6 border transition-all duration-300 hover:scale-[1.02] hover:shadow-lg group cursor-move ${
                  link.isActive 
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="cursor-grab hover:cursor-grabbing p-2 hover:bg-blue-50 rounded-lg transition-all duration-200">
                      <DotsNine size={20} className="text-gray-500 hover:text-blue-600" />
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-blue-600 mt-1 font-mono">{link.url}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      <Button
                        ...
                        className="p-2 hover:bg-blue-50 group/btn transition-all duration-300"
                        title="Copier le lien"
                      >
                        <Copy size={16} className="text-gray-500 group-hover/btn:text-blue-600" />
                      </Button>
                      ...
                      <Button
                        ...
                        title="Éditer"
                      >
                        <Pencil size={16} className="text-gray-500 group-hover/btn:text-blue-600" />
                      </Button>
                      ...
                      <Button
                        ...
                        className="p-2 hover:bg-red-50 group/btn transition-all duration-300"
                        title="Supprimer"
                      >
                        <Trash size={16} className="text-gray-500 group-hover/btn:text-red-600" />
                      </Button>
                    </div>
                  </div>
                </div>
      ...
      {links.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-semibold mb-2 text-gray-900">Aucun lien</h3>
          <p className="text-gray-600 mb-4">Créez votre premier lien pour commencer</p>
          <Button
            onClick={() => setShowAddForm(true)}
