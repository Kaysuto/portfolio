    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {stats.map((stat, index) => (
          <div 
            key={index}
            className="bg-card/80 backdrop-blur-sm rounded-xl p-6 border border-border hover:border-accent/50 transition-all duration-300 hover:scale-105 animate-fadeInUp"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        <div className="bg-card/80 backdrop-blur-sm rounded-xl p-6 border border-border">
          <h3 className="text-lg font-semibold mb-3 text-foreground">Google Analytics</h3>
          <p className="text-sm text-muted-foreground mb-4">
            Connecté et synchronisé avec votre compte GA4
          </p>
          <div className="flex items-center justify-between">
            <span className="text-xs bg-green-500/20 text-green-600 px-2 py-1 rounded">Actif</span>
            <Button variant="outline" size="sm">Configurer</Button>
          </div>
        </div>

        <div className="bg-card/80 backdrop-blur-sm rounded-xl p-6 border border-border">
          <h3 className="text-lg font-semibold mb-3 text-foreground">Cloudflare Analytics</h3>
          <p className="text-sm text-muted-foreground mb-4">
            Statistiques de performance et sécurité
          </p>
          <div className="flex items-center justify-between">
            <span className="text-xs bg-green-500/20 text-green-600 px-2 py-1 rounded">Actif</span>
            <Button variant="outline" size="sm">Voir Dashboard</Button>
          </div>
        </div>
      </div>
    </AdminLayout>
