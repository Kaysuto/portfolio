    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-card/80 backdrop-blur-sm rounded-xl p-6 border border-border">
          ...
          <p className="text-sm text-muted-foreground">Whitelist IP activée</p>
        </div>

        <div className="bg-card/80 backdrop-blur-sm rounded-xl p-6 border border-border">
          <div className="flex items-center space-x-3 mb-3">
            <Lock size={20} className="text-accent" />
            <h3 className="font-semibold text-foreground">Authentification 2FA</h3>
          </div>
        ...
        <div className="bg-card/80 backdrop-blur-sm rounded-xl p-6 border border-border">
          <div className="flex items-center space-x-3 mb-3">
            ...
            <h3 className="font-semibold text-foreground">IP Actuelle</h3>
          </div>
          <p className="text-lg font-mono text-foreground">{currentIP}</p>
          <p className="text-sm text-muted-foreground">
            {whitelistIPs.some(item => item.ip === currentIP) ? (
              <span className="text-green-500">✓ Autorisée</span>
            ) : (
              <span className="text-orange-500">⚠ Non autorisée</span>
            )}
          </p>
        </div>
      </div>
