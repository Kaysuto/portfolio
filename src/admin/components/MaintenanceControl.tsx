...
import { GlassCard, adminDesignTokens } from '../components';
...
export const MaintenanceControl: React.FC<MaintenanceControlProps> = ({ className = '' }) => {
  ...
  if (isLoading) {
    return (
      <GlassCard title="Mode Maintenance" icon={Wrench} delay={100} className={className}>
  ...
  return (
    <div className={className}>
      {/* Status Card */}
      <GlassCard title="Mode Maintenance" icon={Wrench} delay={100} className="mb-4">
      ...
      {/* Configuration Panel */}
      {isExpanded && (
        <GlassCard title="Configuration de la maintenance" icon={Gear} delay={200} className="mb-4">
      ...
      {/* Preview */}
      {maintenanceStatus?.is_enabled && (
        <GlassCard title="Aperçu de la page de maintenance" icon={Wrench} delay={300} className="border-accent-secondary-6 bg-accent-secondary-2/50">
          <div className="text-center py-6 space-y-3">
            <h3 className="text-lg font-semibold text-accent-secondary-11">
              Site en maintenance
            </h3>
            {maintenanceStatus?.message && (
              <p className="text-sm text-accent-secondary-10">
                {maintenanceStatus.message}
              </p>
            )}
            {maintenanceStatus?.estimated_time && (
              <p className="text-xs text-accent-secondary-9">
