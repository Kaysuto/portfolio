            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <section className="space-y-4">
                <div className="flex items-center gap-3 text-accent-texte">
                  ...
                  <h2 className="font-mono text-[10px] font-medium uppercase tracking-[0.25em]">Éditeur</h2>
                </div>
                <div className="bg-card rounded-lg ring-1 ring-foreground/10 p-5 space-y-4">
                  <div>
                    <p className="text-sm font-medium">Kimiya</p>
                    <p className="text-xs text-muted-foreground">Entrepreneur individuel</p>
                  </div>
                  <div className="space-y-1 pt-4 border-t border-border/50">
                    <p className="font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-accent-texte/70">Identifiants</p>
                    <p className="text-xs">SIRET : <span className="text-foreground">91450990600022</span></p>
                    <p className="text-xs">TVA : <span className="text-foreground">FR63914509906</span></p>
                    <p className="text-xs">APE : <span className="text-foreground">6201Z (Programmation informatique)</span></p>
                  </div>
                  <div className="space-y-1 pt-4 border-t border-border/50">
                    <p className="font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-accent-texte/70">Contact</p>
                    <p className="text-xs">
              ...
              <section className="space-y-4">
                <div className="flex items-center gap-3 text-accent-texte">
                  ...
                  <h2 className="font-mono text-[10px] font-medium uppercase tracking-[0.25em]">Hébergement</h2>
                </div>
                <div className="bg-card rounded-lg ring-1 ring-foreground/10 p-5 space-y-6">
                  <div>
                    <p className="font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-accent-texte/70 mb-2">Plateforme</p>
                    <p className="text-sm font-medium">Vercel Inc.</p>
                    <p className="text-xs text-muted-foreground">340 S Lemon Ave #4133, Walnut, CA 91789, USA</p>
                    <p className="text-xs text-muted-foreground mt-1">DPO Europe : c/o EDPO, Avenue Huart Hamoir 71, 1030 Bruxelles, Belgique</p>
                  </div>
                  <div className="pt-4 border-t border-border/50">
                    <p className="font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-accent-texte/70 mb-2">Base de données &amp; Backend</p>
                    <p className="text-sm font-medium">Supabase Inc.</p>
                    <p className="text-xs text-muted-foreground">65 Chulia Street #38-02/03, OCBC Centre, Singapore 049513</p>
                    <p className="text-xs text-muted-foreground mt-1">Données stockées dans la région EU (Frankfurt, AWS eu-central-1)</p>
                  </div>
                </div>
              </section>
            </div>
...
{/* Données personnelles & RGPD */}
            <section className="space-y-4">
              <div className="flex items-center gap-3 text-accent-texte">
                ...
                <h2 className="font-mono text-[10px] font-medium uppercase tracking-[0.25em]">Données personnelles &amp; Cookies</h2>
              </div>
              <div className="bg-card rounded-lg ring-1 ring-foreground/10 p-5 space-y-6">
                ...
                <div className="pt-6 border-t border-border/50 space-y-4">
                  <h3 className="font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-accent-texte">Données collectées</h3>
                ...
                <div className="pt-6 border-t border-border/50 space-y-4">
                  <h3 className="font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-accent-texte">Cookies</h3>
                  <p className="text-xs/relaxed text-muted-foreground">
                ...
                <div className="pt-6 border-t border-border/50 space-y-4">
                  <h3 className="font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-accent-texte">Vos droits (RGPD)</h3>
                  <p className="text-xs/relaxed text-muted-foreground">
            ...
            <section className="space-y-4">
              <div className="flex items-center gap-3 text-accent-texte">
                ...
                <h2 className="font-mono text-[10px] font-medium uppercase tracking-[0.25em]">Propriété Intellectuelle</h2>
              </div>
              <div className="bg-card rounded-lg ring-1 ring-foreground/10 p-5 space-y-6">
                {/* Copyright Principal */}
                ...
                {/* Protection Légale */}
                <div className="pt-6 border-t border-border/50 space-y-4">
                  <h3 className="font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-accent-texte">Protection Légale</h3>
                  <p className="text-muted-foreground leading-relaxed font-medium">
                ...
                <div className="pt-6 border-t border-border/50 space-y-4">
                  <h3 className="font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-accent-texte">Restrictions d'Utilisation</h3>
                  <ul className="space-y-2 text-xs/relaxed text-muted-foreground">
                    <li className="flex gap-3">
                      <span className="text-accent-texte mt-0.5">•</span>
                ...
                {/* Exceptions */}
                <div className="pt-6 border-t border-border/50 space-y-4">
                  <h3 className="font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-accent-texte">Exceptions</h3>
                  <p className="text-muted-foreground leading-relaxed font-medium">
