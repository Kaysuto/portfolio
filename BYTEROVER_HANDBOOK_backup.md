...
- **Dashboard.tsx** - Dashboard  avec métriques essentielles
- **LinksManager.tsx** - CRUD liens
- **Maintenance.tsx** - Configuration maintenance
- **Analytics.tsx** - Analytics de base avec graphiques simulés
